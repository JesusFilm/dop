...
- KTD4. **Synchronize by polling authoritative snapshots rather than keeping process-local live state.** A shared client hook polls while the page is visible, backs off after failures, and redirects when the gathering phase or participant assignment changes. This remains correct across Railway restarts and avoids a premature WebSocket or pub/sub dependency for 50 participants. Governs R6, R7, R8, R16, R18, R20, R21, R26, R27.
